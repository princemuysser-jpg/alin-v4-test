...
(function(){
  ...
  window.AlinCourierCore=Object.freeze({
    version:window.ALIN_CONFIG?.version||'4.2.0-rc.18',$, $$, arr, escv, moneyv, now, notify, currentAccount, dbx,
...
(function(){
  ...
  window.AlinCourierDashboard=Object.freeze({version:window.ALIN_CONFIG?.version||'4.2.0-rc.18',resolveCourier,myOrders,refreshCourierData,render:renderCourierDashboard});
...
(function(){
  ...
  const VERSION='4.2.0-rc.18';
  const SOUND_URL='./assets/audio/alin-order-chime.wav?v=4.2.0-rc.18';
