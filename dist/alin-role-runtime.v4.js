...
(function(){
  ...
  window.AlinCourierCore=Object.freeze({
    version:window.ALIN_CONFIG?.version||'4.2.0-rc.17',$, $$, arr, escv, moneyv, now, notify, currentAccount, dbx,
...
(function(){
  ...
  window.AlinCourierDashboard=Object.freeze({version:window.ALIN_CONFIG?.version||'4.2.0-rc.17',resolveCourier,myOrders,refreshCourierData,render:renderCourierDashboard});
