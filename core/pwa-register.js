/* ALIN v4.2.0 RC13 — idle PWA registration for weak-network startup. */
(function(){
  'use strict';
  ...
  window.addEventListener('load',()=>schedule(async()=>{
    try{
      const registration=await navigator.serviceWorker.register('./service-worker.js?v=4.2.0-rc.13',{scope:'./',updateViaCache:'none'});
