/* ALIN v4.2.0 RC14 — role runtime lazy loader. Public storefront never downloads staff dashboards until needed. */
(function(){
  'use strict';
  let state='idle';
  let promise=null;
  const version=window.ALIN_CONFIG?.version||'4.2.0-rc.14';
