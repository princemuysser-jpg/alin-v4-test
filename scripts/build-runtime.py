...
'modules/library/finance.js','modules/library/printing.js','modules/printer/dashboard.js','modules/admin/dashboard.js','modules/admin/orders.js','modules/admin/orders-grouped.js',
...
'modules/admin/delivery-pricing.js','modules/courier/assignment.js','modules/courier/dashboard.js','modules/courier/book-pickup-source.js','modules/courier/finance.js','modules/admin/courier-hub.js','modules/core/security.js',
'modules/admin/backup.js','modules/core/backend-check.js','modules/core/account-admin-service.js','modules/core/order-bell.js','modules/core/order-attention.js',
