...
'modules/core/notifications.js','modules/store/coupons.js','modules/admin/shell.js','modules/core/features.js',
...
'modules/admin/coupons.js','modules/admin/reports.js','modules/admin/settings.js','modules/admin/notifications.js',
...
concat(PUBLIC_APP+['store/notifications.js'],ROOT/'alin-app-desktop.v4.1.5.js')
concat(PUBLIC_APP+['store/mobile-navigation.js','store/notifications.js'],ROOT/'alin-app-mobile.v4.1.5.js')
