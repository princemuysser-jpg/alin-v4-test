...
(function(){
  ...
  Object.assign(window,{
    ALIN_VERSION:window.ALIN_CONFIG?.version||'4.2.0-rc.20',init,requireConnection,audit,renderAll,seedData,
  ...
  window.AlinRuntime=Object.freeze({version:window.ALIN_CONFIG?.version||'4.2.0-rc.20',init,requireConnection,renderAll,getDb:()=>stateDb,getCurrent:()=>stateCurrent});
