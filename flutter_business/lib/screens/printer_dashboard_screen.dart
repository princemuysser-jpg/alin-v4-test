...
class _PrinterDashboardScreenState extends State<PrinterDashboardScreen> {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'حساب المطبعة وتوريد الكتب والتسويات والوصولات',
    ...
    return LayoutBuilder(
      builder: (context, c) {
        ...
        final cards = [
          ...
          _metric(
            'توريد كتب مستحق',
            money(summary['book_supply_pending']),
            Icons.menu_book_rounded,
          ),
          _metric(
            'طلبات الكتب',
            '${summary['book_orders_count'] ?? 0}',
  ...
  Widget _booksSection() {
    ...
    return Column(
      ...
      children: [
        const Text(
          'طلبات وحركات توريد الكتب',
          style: TextStyle(fontSize: 17, fontWeight: FontWeight.w900),
        ),
        const SizedBox(height: 5),
        Text(
          'المستحق ${money(summary['book_supply_pending'])} — المسدد ${money(summary['book_supply_settled'])}',
          ...
          ...rows.map(
            (row) => Card(
              ...
              child: ListTile(
                ...
                title: Text(
                  '${row['order_number'] ?? row['order_id'] ?? 'طلب كتاب'}',
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'ذمة المطبعة منفصلة عن مستحق توريد الكتب. التسوية من الإدارة تحفظ السجل ولا تمس حساب توريد الكتب.',
                    style: TextStyle(color: Colors.grey.shade700),
                  ),
                ),
              ],
    ...
    return Column(
      ...
      children: [
        ...
        if (book.isEmpty)
          ...
          ...book.map(
            (row) => _settlementCard(row, fallback: 'تسوية توريد كتب'),
          ),
        const SizedBox(height: 14),
        const Text(
          'تسويات ذمة المطبعة',
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              error ?? 'تعذر تحميل بيانات المطبعة',
