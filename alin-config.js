// منصة آلين v4.1.9.0 — تحسين السرعة وفصل جلسات الطلبة وإصلاح فتح الصفحات.
window.ALIN_CONFIG=Object.freeze({
  version:'4.1.9.0-complete-deployment-fix',
...
(function loadAlinPerformanceLayer(){
  ...
  script.src='./alin-performance-v4.1.7.js?v=4.1.9.0';
  script.defer=true;
